...
function newWindow(x,y,title,content,resize,min,max) {
	...
	var minString = "";
	var maxString = "";
	if(min) minString = "<img draggable=\"false\" ondragstart=\"return false;\" src=\"skins/"+lStore("skin")+"/ui/min.png\" onmouseover=\"this.src='skins/"+lStore("skin")+"/ui/minHover.png';\" onmouseout=\"this.src='skins/"+lStore("skin")+"/ui/min.png';\" onmousedown=\"this.src='skins/"+lStore("skin")+"/ui/minDown.png';\" onmouseup=\"this.src='skins/"+lStore("skin")+"/ui/min.png';\" class=\"minButton\" onclick=\"minMaxWindow('" + newWindow + "','" + windowTab + "')\"/>";
	if(max) maxString = "<img draggable=\"false\" ondragstart=\"return false;\" src=\"skins/"+lStore("skin")+"/ui/max.png\" onmouseover=\"this.src='skins/"+lStore("skin")+"/ui/maxHover.png';\" onmouseout=\"this.src='skins/"+lStore("skin")+"/ui/max.png';\" onmousedown=\"this.src='skins/"+lStore("skin")+"/ui/maxDown.png';\" onmouseup=\"this.src='skins/"+lStore("skin")+"/ui/max.png';\" class=\"maxButton\" onclick=\"maxRestoreWindow('" + newWindow + "','" + windowTab + "')\"/>";
...
function minMaxWindow(winID,tabID) {
	...
	if ($(winID).style.display == "block") {
		...
		$(tabID).style.backgroundImage = "URL('skins/" + lStore("skin") + "/ui/backing_down.png')";
	}
}
